...
\begin{itemize}
  \item It collects data from external systems and periodically fetches/checks the necessary entities (jobs, nodes, queues, reservations, users, infrastructure descriptions, projects, virtual machines, \dots).
