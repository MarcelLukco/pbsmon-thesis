...
As mentioned in the section~\ref{sec:authentication}, the old PBSMon solution uses uses third-party authentication provided by Perun's e-INFRA system. The new solution uses same third-party authentication using the same OIDC authentication protocol.
